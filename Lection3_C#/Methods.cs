/*
// Вид 1 ничего не принимает и ничего не принимает
void Method1()
{
...
//Method21("Текст", 4);
Method21(count: 4, msg: "Текст"); // таким образом можно записывать именованые аргументы (не имеет значение последовательность)
...
// Вид 4 что-то принимает и что-то возвразщает
